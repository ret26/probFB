function test_suite = test_trainVFEFFT
...
function test_train1
    ...
    for n = 1:notrials
        for l = 1:L
            ...
            y = ytrue + 0.1*randn(T,1);
            
            kernel.name = 'SE';
            params = [log(varx),log(lenx),log(0.1)]';

            [params,info] = trainVFEFFT(y,kernel,M,setup,params);
    ...
    oriSpec = getVFESpecHelper(kernel,params(1:end-1),T);
    [mf,vf] = denoiseVFEFFT(y,oriSpec,exp(params(end)),M);
    figure, hold on,
...
function test_train2
    ...
    for n = 1:notrials
        for l = 1:L
            ...
            [params,info] = trainVFEFFTAdaptive(y,kernel,M,setup,params);
