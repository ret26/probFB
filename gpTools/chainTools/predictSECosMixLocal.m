function [fest,vest] = testing_predictSECosMixLocal(theta,K,covfunc,Xtrain,Ytest,tau1,tau2,missingInd)
...
vary = exp(theta(end));
[Ct,Rt,Qt] = ...
    testing_getParamsSECosMixLocal(covfunc,covhyp,mu,vary,Xtrain,tau1,tau2,noblks,missingInd);
...
% keyboard
[Xfint,Pfint] = testing_kalmanVarLocal(Ct,Qt,Rt,x0,P0,yKalman,1,0);
