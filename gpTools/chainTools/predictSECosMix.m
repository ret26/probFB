function [fest,vest] = testing_predictSECosMix(theta,K,covfunc,Xtrain,Ytest,tau1,tau2,missingInd)
...
vary = exp(theta(end));
[Ct,Rt,At,Qt] = ...
    testing_getParamsSECosMix(covfunc,covhyp,mu,vary,Xtrain,tau1,tau2,noblks,missingInd);
% initial condition
...
% keyboard
[Xfint,Pfint] = testing_kalmanVar(At,Ct,Qt,Rt,x0,P0,yKalman,1,0);
