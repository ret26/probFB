...
plot(snr_y(:,1),snr_y(:,2)-snr_y(:,1),'--','color',[0,0.6,0])
plot(snr_y(:,1),snr_y(:,3)-snr_y(:,1),'-','color',[0,0.6,0])
plot(snr_y(:,1),snr_y(:,4)-snr_y(:,1),'-b')
plot(snr_y(:,1),snr_y(:,5)-snr_y(:,1),'-r')

for k=1:length(noise_level)
  plot(snr_y(noise_level(k),1),delta3(noise_level(k)),'ob')
  plot(snr_y(noise_level(k),1),delta4(noise_level(k)),'or')
end
...
for k=1:length(noise_level)
  plot(pesq_y(noise_level(k),1),delta3(noise_level(k)),'ob')
  plot(pesq_y(noise_level(k),1),delta4(noise_level(k)),'or')
end
...
plot(snr_loga_mn(:,1),snr_loga_mn(:,5)-snr_loga_mn(:,1),'-r')

for k=1:length(noise_level)
  plot(snr_loga_mn(noise_level(k),1),delta3(noise_level(k)),'ob')
  plot(snr_loga_mn(noise_level(k),1),delta4(noise_level(k)),'or')
end
...
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),4,noise_level(1)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),5,noise_level(1)),'-','color',colGTFtNMF)
...
plot(tim1,yTest(nsip_lim(1,1):nsip_lim(1,2)),'-k','linewidth',1)
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),4,noise_level(2)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),5,noise_level(2)),'-','color',colGTFtNMF)
...
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),4,noise_level(1)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),5,noise_level(1)),'-','color',colGTFtNMF)
...
plot(tim1,yTest(nsip_lim(2,1):nsip_lim(2,2)),'-k','linewidth',1)
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),4,noise_level(2)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),5,noise_level(2)),'-','color',colGTFtNMF)
...
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),4,noise_level(1)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),5,noise_level(1)),'-','color',colGTFtNMF)
...
plot(tim1,yTest(nsip_lim(3,1):nsip_lim(3,2)),'-k','linewidth',1)
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),4,noise_level(2)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),5,noise_level(2)),'-','color',colGTFtNMF)
