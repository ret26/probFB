...
saveName = 'reconstruction_fig_new.eps'
...
for k=1:numGaps
  ...
  snrGTFtNMF1 =snr(yTest(indCur),Ys(indCur,5,trial1));
  snrGTF1 =snr(yTest(indCur),Ys(indCur,4,trial1));
  snrGTFtNMF2 =snr(yTest(indCur),Ys(indCur,5,trial2));
  snrGTF2 =snr(yTest(indCur),Ys(indCur,4,trial2));
  ...
  plot(Ys(indCur,4,trial1),'-','color',colGTF)
  plot(Ys(indCur,5,trial1),'-','color',colGTFtNMF)
  ...
  plot(Ys(indCur,4,trial2),'-','color',colGTF)
  plot(Ys(indCur,5,trial2),'-','color',colGTFtNMF)
  plot(yTest(indCur),'-k','linewidth',2)
...
disp(['waveform improvement over GTF   ',num2str(mean(delta4-delta3)),'dB'])


%plot(gapsms,snr_y(:,2),'--k')
plot(gapsms,snr_y(:,3),'-','color',[0,0.6,0])
plot(gapsms,snr_y(:,4),'-b')
plot(gapsms,snr_y(:,5),'-r')

for k=1:length(gaps_plot)
  plot(gapsms(gaps_plot(k)),snr_y(gaps_plot(k),4),'ob')
  plot(gapsms(gaps_plot(k)),snr_y(gaps_plot(k),5),'or')
end

%legend('NMF','tNMF','GTF','GTFtNMF','location','northeast')
legend('tNMF','GTF','GTFtNMF','location','northeast')
...
disp(['pesq improvement over GTF   ',num2str(mean(delta4-delta3)),'units'])
...
disp(['loga SNR improvement over NMF   ',num2str(mean(delta4-delta2)),'dB'])
...
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),4,gaps_plot(1)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),5,gaps_plot(1)),'-','color',colGTFtNMF)
...
set(gca,'Layer','top') 
plot(tim1,yTest(nsip_lim(1,1):nsip_lim(1,2)),'-k','linewidth',1)
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),4,gaps_plot(2)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(1,1):nsip_lim(1,2),5,gaps_plot(2)),'-','color',colGTFtNMF)
...
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),4,gaps_plot(1)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),5,gaps_plot(1)),'-','color',colGTFtNMF)
...
plot(tim1,yTest(nsip_lim(2,1):nsip_lim(2,2)),'-k','linewidth',1)
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),4,gaps_plot(2)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(2,1):nsip_lim(2,2),5,gaps_plot(2)),'-','color',colGTFtNMF)
...
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),4,gaps_plot(1)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),5,gaps_plot(1)),'-','color',colGTFtNMF)
...
plot(tim1,yTest(nsip_lim(3,1):nsip_lim(3,2)),'-k','linewidth',1)
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),4,gaps_plot(2)),'-','color',colGTF)
plot(tim1,Ys(nsip_lim(3,1):nsip_lim(3,2),5,gaps_plot(2)),'-','color',colGTFtNMF)
