function [W,H,mnV,covV,info] = GTFNMF(y,W,H,lamv,varv,omv,vary,varargin)

% function [W,H,mnV,covV,info] = GTFtNMF(y,H,W,lamv,varv,omv,vary,varargin)
%
...
disp('GTFNMF: converting to basis function representation')
...
for it=1:L
  ...
  [zlogW, ObjCur, itCur] = minimize(zlogW,'getObj_GTFtNMF_FB_hier', ...
				    numIts(it),y,lamv,varv,omv, ...
				    vary,lenx,mux,varx,0,tol);
  timCur = toc;
