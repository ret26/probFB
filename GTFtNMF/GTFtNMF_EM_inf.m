function [H,mnV,covV,info] = GTFtNMF_EM_inf(y,W,H,lamv,varv,omv,vary,lenx,mux,varx,varargin)

% function [H,mnV,covV,info] = GTFtNMF_EM_inf(y,H,W,lamv,varv,omv,vary,lenx,mux,varx,varargin)
%
% Carries out expectation maximisation inference of the GTF-tNMF
% model -- does not learn the spectral basis functions.
%
...
%				    vary,lenx,mux,varx,tol);
  ...
  % M-Step
  [z, ObjCur, itCur] = minimize(z,'getObj_GTFtNMF_FB_hier_EM_inf', ...
				    numIts(it),W,VV',RVV',lamv,varv, ...
				    lenx,mux,varx,1,tol);
  timCur = toc;
