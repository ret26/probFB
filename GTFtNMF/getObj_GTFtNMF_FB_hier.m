function [Obj,dObj] = getObj_GTFtNMF_FB_hier(zlogw,y,lamv,varv,omv, ...
...
% split it up into smaller modules.
  ...
  [ObjA,Xfin,Pfin] = kalman_GTFtNMF_FB_hier(y,A',lamv,varv,omv,vary);
...
Obj = (-ObjA+ObjB)/T;
dObj = ([dObjAdZ(:)+dObjBdZ(:);dObj1dW(:)])/T;
