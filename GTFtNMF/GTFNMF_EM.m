function [W,H,mnV,covV,info] = GTFNMF_EM(y,W,H,lamv,varv,omv,vary,varargin)

% function [W,H,mnV,covV,info] = GTFNMF_EM(y,H,W,lamv,varv,omv,vary,varargin)
%
...
% 
% There is no prior on the Zs though.
%
% INPUTS
% y = signal [T,1]
...
disp('GTFNMF_EM: converting to basis function representation')
...
for it=1:numEMIts
  ...
  likCur = (likCur)/T; %  scale by # data points
