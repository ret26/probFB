function test_suite = test_GTFtNMF
  initTestSuite;
...
%[WEst,HEst,mnV,covV,info] = GTFtNMF_EM(y,WInit,HInit,lamv,varv,omv,vary, ...
%				       lenx,mux,varx);

[WEst,HEst,mnV,covV,info] = GTFtNMF(y,WInit,HInit,lamv,varv,omv,vary, ...
				       lenx,mux,varx);
