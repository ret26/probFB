function test_suite = test_kalman_GTFtNMF_FB_prod
  initTestSuite;

% Tests: 
%
% [lik,Xfin,Pfin] = kalman_GTFtNMF_FB_prod(y,Amp,lamx,varx,omx,vary);
%
...
[lik2,Xfin2,Pfin2] = kalman_GTFtNMF_FB_prod(Y(:),Amp,lamx,varx,om,vary);
...
function testCompareHierachical
...
[lik1,Xfin1,Pfin1] = kalman_GTFtNMF_FB_hier(Y(:),Amp,lamx,varx,om,vary);
[lik2,Xfin2,Pfin2] = kalman_GTFtNMF_FB_prod(Y(:),Amp,lamx,varx,om,vary);
