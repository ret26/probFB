function  [lik,VV,RVV] = kalman_GTFtNMF_FB_hier_EM(y,Amp,lamx,varx,omx,vary,varargin);

% function [lik,VV,RVV] = kalman_mPAD_FB_hier_EM(y,Amp,lamx,varx,omx,vary)
% 
...
for t=(T-1):-1:1
  ...
  %%%%%%%
  % sufficient statistics required for E-Step
...
VVcur = reshape(diag(Asc*EXXlag),[2,K/2]);
RVV(:,t-1) = sum(VVcur,1)';
