function  [lik,Xfin,Pfin,varargout] = kalmanSlowSTFT(lamx,varx,om, ...
						  vary,y,varargin);
...
% 
% Implements the probabilistic STFT (see Qi and Minka,
% 2002). Optionally returns the sufficient statistics of the Gaussian
...
%
% function
% [lik,Xfin,Pfin,Ptsum,YX,A1,A2,A3]=kalmanSlowSTFT(lamx,varx,om,vary,Y,verbose,KF);
%
% see test_kalmanSlowSTFT.m for unit tests.
% 
% INPUTS:
