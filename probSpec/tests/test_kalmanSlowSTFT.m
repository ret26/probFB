function test_suite = test_kalmanSlowSTFT
  initTestSuite;

% Tests: 
%
% function % [lik,Xfin,Pfin,Ptsum,YX,A1,A2,A3]=kalmanSlowSTFT(lamx,varx,om,vary,Y,verbose,KF);
%
...
sigmaPostKF = inv(inv(P0)+C1'*inv(R)*C1);
muPostKF = sigmaPostKF*(x0'*inv(P0)+Y0'*inv(R)*C1)';
...
[lik2,Xfin2,Pfin2] = kalmanSlowSTFT(lamx,varx,om,vary,Y(:),0,1);
