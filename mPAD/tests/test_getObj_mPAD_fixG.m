function test_suite = test_getObj_mPAD_fixG
  initTestSuite;

% Tests: 
%
% function [Obj,dObj] = getObj_mPAD_fixG(X2G,y,fftCov,Params);
%
...
GScale = rand(K,1);
d=checkgrad('getObj_mPAD_fixG',x2g,delta,y,fftCov,Params,GScale)
