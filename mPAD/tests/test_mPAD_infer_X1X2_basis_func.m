function test_suite = test_mPAD_infer_X1X2_basis_func
  initTestSuite;
...
[X1,X2,Info] = mPAD_infer_X1X2_basis_func(y,X2,Params,opts);
...
opts.numIts = 200; 
[X1Est,X2Est,Info] = mPAD_infer_X1X2_basis_func(y,Z2Init,Params,opts);
