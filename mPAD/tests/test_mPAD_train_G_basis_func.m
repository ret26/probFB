function test_suite = test_mPAD_train_G_basis_func
  initTestSuite;

% Tests: 
%
% function [X1,X2,Params,Info] = mPAD_train_G_basis_func(y,Z2,Params,,opts)
%
...
Z2 = zeros(T,K);
[X1,X2,Params,Info] = mPAD_train_G_basis_func(y,Z2,Params,opts);
...
opts.numIts = 600;
Z2 = -3*ones(T,K);
ParamsInit.vary = 0.001;

[X1Est,X2Est,ParamsEst,Info] = mPAD_train_G_basis_func(y,Z2,ParamsInit,opts);
