...
% function [W,H,info] = tnmf(A,W,H,lenx,mux,varx,vary,varargin)
%
% Performs temporal NMF on the data matrix A. That is, it approximates A
...
for l=1:L
  ...
  [xlogW, ObjCur, itCur] = minimize(xlogW,'getObj_nmf_log_norm', ...
				      numIts(l),A,vary,lenx,mux,varx,tol);
  timCur = toc;

  % Pull out H and W from xlogW
